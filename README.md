...
1. Update your webhook handler to call `validateWebhook(request, secret)`, where `request` is an instance of a [web-standard `Request` object](https://developer.mozilla.org/ru/docs/Glossary/World_Wide_Web), and `secret` is the signing secret for your environment.
