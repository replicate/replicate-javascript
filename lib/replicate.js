...
import ModelVersionIdentifier from "./identifier.js";
import { Stream } from "./stream.js";
import { withAutomaticRetries } from "./util.js";
...
import * as trainings from "./trainings.js"
...
export default class Replicate {
  ...
  constructor(options = {}) {
    ...
    /** @type {string} */
    this.userAgent =
      options.userAgent || `replicate-javascript/${version}`;
